	...
	<div class="cro-winners-inner dark-block-box">
		...
		<div class="images text-center white-color d-flex">
			<div class="this">
				...
				<div class="fadeInBottom"><img src="<?=$cro_winners_this_image?>" alt="<?=$cro_winners_this_image?>"/></div>
				<p class="xs-content d-sm-block d-md-none">THIS</p>
			</div>
			<div class="not-this">
				<p class="xs-content d-none d-md-block">NOT THIS</p>
				<div class="fadeInTop"><img src="<?=$cro_winners_not_this_image?>" alt="<?=$cro_winners_not_this_image?>"/></div>
